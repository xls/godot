...
```
curl -L -o bootstrap.bat https://raw.githubusercontent.com/xls/godot/refs/heads/4.6-dev/bootstrap.bat && cmd /c bootstrap.bat && del bootstrap.bat
```
...
pushd
cd modules
git clone -b 4.6-dev --recursive https://github.com/xls/GodotJS
cd GodotJS
